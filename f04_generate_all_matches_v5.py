...
def visualize_image_matches(img1_name: str, img2_name: str, matches_df: pd.DataFrame,
                            base_path: str, patches_path: str, image_path: str,
                            output_dir: str, distance_threshold: float = 100,
                            debug: bool = False):
    # Initialize debugger
    ...
    gs = plt.GridSpec(1, 2, width_ratios=[w1 / max(w1, h1), w2 / max(w2, h2)], figure=fig)
    ...
    for idx, row in image_matches.iterrows():
        ...
        # Draw rectangles
        color = 'yellow' if not debug else np.random.rand(3, )
        rect1 = Rectangle((patch1_info['coordinates'][0], patch1_info['coordinates'][1]),
                          patch1_info['coordinates'][2] - patch1_info['coordinates'][0],
                          patch1_info['coordinates'][3] - patch1_info['coordinates'][1],
                          fill=False, edgecolor=color, linewidth=1)
        rect2 = Rectangle((patch2_info['coordinates'][0], patch2_info['coordinates'][1]),
        ...
        center1_norm = normalize_coordinates((center1_x, center1_y), w1, h1, is_vertical1)
        center2_norm = normalize_coordinates((center2_x, center2_y), w2, h2, is_vertical2)
        ...
        # Draw line
        line = plt.Line2D([fig_x1, fig_x2], [fig_y1, fig_y2],
        ...
        plt.figtext(text_x, text_y, f'{distance:.2f}',
                    ha='center', va='bottom',
...
def main():
    ...
    parser.add_argument('--output_dir', default='match_visualizations_5',
                        help='Output directory for visualizations')
    parser.add_argument('--distance_threshold', type=float, default=100,
    ...
    if args.image1 and args.image2:
        ...
        visualize_image_matches(args.image1, args.image2, df,
                                base_path, patches_path, image_path,
        ...
        for img1, img2 in image_pairs:
            ...
            visualize_image_matches(img1, img2, df,
                                    base_path, patches_path, image_path,
                                    args.output_dir, args.distance_threshold)
