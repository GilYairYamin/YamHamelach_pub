...
def visualize_all_matches(df_matches: pd.DataFrame, base_path: str, image_path: str,
    ...
    for idx, row in df_matches.iterrows():
        ...
        # Draw center points and connecting lines
        ...
        # Plot center points
        ax1.scatter(center1_x, center1_y, c='blue', marker='o', s=50)
        ax2.scatter(center2_x, center2_y, c='blue', marker='o', s=50)

        # Add match score or other relevant information as text
        ax1.annotate(f'Match {match_cnt + 1}', (center1_x, center1_y),
                     xytext=(5, 5), textcoords='offset points')
        ax2.annotate(f'Match {match_cnt + 1}', (center2_x, center2_y),
                     xytext=(5, 5), textcoords='offset points')
    ...
    # Add overall title
    plt.suptitle("All Matching Patches Between Images", fontsize=16)
    plt.tight_layout()
...
def main():
    ...
    for img1_name, img2_name in img_pairs:
        ...
        if len(pair_matches) > 0:
            ...
            fig.savefig(os.path.join(output_dir, f"{img1_name}_vs_{img2_name}_patches.jpg"))
            plt.close(fig)
