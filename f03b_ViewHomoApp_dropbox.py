...
def get_patch_info_from_dropbox(
    dropbox_handler, base_path, file_name: str, box: str
) -> dict:
    """
...
def visualize_match(
    ...
    if patch1_info is None or patch2_info is None:
        logger.error(
            f"Couldn't load patch info for one of the matches {patch1_info} - {patch2_info}. Skipping..."
        )
        return
    ...
    if img1 is None or img2 is None:
        logger.error("Couldn't img1 and img2...")
        return
